...
local function ParseMessage(message, sender)
    ...
    if lowerMessage == "guildkarma" or lowerMessage == "!guildkarma" or lowerMessage == "!karma" or lowerMessage == "karma" then
...
local function ShowKarma(playerName)
    ...
    if playerName and playerName ~= "" then
        ...
        table.sort(karmaList, function(a, b) return a.karma > b.karma end)
